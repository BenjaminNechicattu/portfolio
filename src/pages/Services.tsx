...
const serviceOptions = [
  {
    ...
    visuals: [
      { title: 'Pencil / Charcoal', type: 'image', url: 'https://img-c.udemycdn.com/course/480x270/3629932_6904_2.jpg', 
        description: 'Pencil/charcoal drawings. Portraits' },
      { title: 'Quilling', type: 'image', url: 'https://i.pinimg.com/736x/18/90/26/189026e13500ea29e709299c4a3d430d.jpg',
        description: 'Quilling Names. Framed Art Gifts' },
      { title: 'Acrylic Painting', type: 'image', url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4HST1PeLhyJ7pxYDm7-olxoxoa_c7LC7czA&s',
        description: 'Acrylic paintings. Detailed and vibrant canvases' },
      { title: 'Pencil Carving', type: 'image', url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3jrJIOi3f2y18iSuYgQN_K69ULhhI73ZHng&s',
  ...
  },
  {
    ...
    visuals: [
      { title: 'UI/UX Design', type: 'image', url: 'https://img-c.udemycdn.com/course/480x270/3629932_6904_2.jpg', 
        description: 'UI/UX Design, match your vibe' },
      { title: 'Brand Identity', type: 'image', url: 'https://i.pinimg.com/736x/18/90/26/189026e13500ea29e709299c4a3d430d.jpg',
        description: 'Logo and brand identity designs' },
      { title: 'Ad Design', type: 'image', url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4HST1PeLhyJ7pxYDm7-olxoxoa_c7LC7czA&s',
        description: 'Better ad designs for your marketing needs' },
      { title: 'Poster Design', type: 'image', url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3jrJIOi3f2y18iSuYgQN_K69ULhhI73ZHng&s',
